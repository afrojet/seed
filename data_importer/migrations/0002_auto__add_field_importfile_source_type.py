...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImportFile.source_type'
        db.add_column(u'data_importer_importfile', 'source_type',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImportFile.source_type'
        db.delete_column(u'data_importer_importfile', 'source_type')
