...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ImportFile.mapping_confidence'
        db.delete_column(u'data_importer_importfile', 'mapping_confidence')

        # Deleting field 'ImportFile.initial_mapping_done'
        db.delete_column(u'data_importer_importfile', 'initial_mapping_done')

        # Deleting field 'ImportFile.is_espm'
        db.delete_column(u'data_importer_importfile', 'is_espm')

        # Deleting field 'ImportFile.coercion_mapping_done'
        db.delete_column(u'data_importer_importfile', 'coercion_mapping_done')

        # Deleting field 'ImportFile.mapping_active'
        db.delete_column(u'data_importer_importfile', 'mapping_active')

        # Deleting field 'ImportFile.has_source_id'
        db.delete_column(u'data_importer_importfile', 'has_source_id')

        # Adding field 'ImportFile.raw_save_done'
        db.add_column(u'data_importer_importfile', 'raw_save_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ImportFile.raw_save_completion'
        db.add_column(u'data_importer_importfile', 'raw_save_completion',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ImportFile.mapping_done'
        db.add_column(u'data_importer_importfile', 'mapping_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ImportFile.mapping_completion'
        db.add_column(u'data_importer_importfile', 'mapping_completion',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ImportFile.matching_done'
        db.add_column(u'data_importer_importfile', 'matching_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ImportFile.matching_completion'
        db.add_column(u'data_importer_importfile', 'matching_completion',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ImportFile.mapping_confidence'
        db.add_column(u'data_importer_importfile', 'mapping_confidence',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ImportFile.initial_mapping_done'
        db.add_column(u'data_importer_importfile', 'initial_mapping_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ImportFile.is_espm'
        db.add_column(u'data_importer_importfile', 'is_espm',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ImportFile.coercion_mapping_done'
        db.add_column(u'data_importer_importfile', 'coercion_mapping_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ImportFile.mapping_active'
        db.add_column(u'data_importer_importfile', 'mapping_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ImportFile.has_source_id'
        db.add_column(u'data_importer_importfile', 'has_source_id',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ImportFile.raw_save_done'
        db.delete_column(u'data_importer_importfile', 'raw_save_done')

        # Deleting field 'ImportFile.raw_save_completion'
        db.delete_column(u'data_importer_importfile', 'raw_save_completion')

        # Deleting field 'ImportFile.mapping_done'
        db.delete_column(u'data_importer_importfile', 'mapping_done')

        # Deleting field 'ImportFile.mapping_completion'
        db.delete_column(u'data_importer_importfile', 'mapping_completion')

        # Deleting field 'ImportFile.matching_done'
        db.delete_column(u'data_importer_importfile', 'matching_done')

        # Deleting field 'ImportFile.matching_completion'
        db.delete_column(u'data_importer_importfile', 'matching_completion')
