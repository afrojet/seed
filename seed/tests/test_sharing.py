...
class SharingViewTests(TestCase):
    ...
    def _create_sharing(self):
        ...
        fields = ['property_name',
                  ...
                  'postal_code']
        for field in fields:
            ExportableField.objects.create(field_model='BuildingSnapshot',
                                           name=field,
    ...
    def _get_building(self, building_id):
        ...
        params = {
            ...
            'organization_id': self.eng_org.pk,
        }
    ...
    def test_parent_detail_view_parent_org(self):
        ...
        """
        self.client.login(**self.admin_details)
        b = self.parent_org.building_snapshots.first()
        result = self._get_building(b.pk)

        self.assertEqual(
            result['building']['address_line_1'],
            b.address_line_1
        )
    ...
    def test_parent_detail_view_suborg(self):
        ...
        """
        self.client.login(**self.admin_details)
        b = self.eng_org.building_snapshots.first()
        result = self._get_building(b.pk)
    ...
    def test_shared_detail_view(self):
        ...
        """
        self.client.login(**self.eng_user_details)
        b = self.des_org.building_snapshots.first()

        result = self._get_building(b.pk)
        self.assertTrue('address_line_1' not in result['building'])
