...
describe("controller: mapping_controller", function(){
    ...
    function create_mapping_controller(){
        ...
        var mock_be_building_types = {'gross_floor_area': 'float'};
    ...
    it("should show suggested mappings and confidence", function() {
        ...
        expect(first_column.suggestion).toBe("pm_property_id");
    });
    ...
    it("should detect duplicates", function() {
        ...
        var property_name_column = mapping_ctrl_scope.raw_columns[1];
        ...
        // the property_id tcm.
        property_name_column.suggestion = 'pm_property_id';
    ...
    it("should get mappings in an API friendly way", function() {
        ...
        expect(mappings[0]).toEqual(['pm_property_id', 'property id']);
        // everything in between is empty since we we're using only
        // suggested mappings.
        expect(mappings[3]).toEqual(['tax_lot_id', 'lot number']);
    });
