...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CanonicalBuilding.active'
        db.add_column(u'seed_canonicalbuilding', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CanonicalBuilding.active'
        db.delete_column(u'seed_canonicalbuilding', 'active')
