...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BuildingSnapshot.block_number_source'
        db.add_column(u'seed_buildingsnapshot', 'block_number_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['seed.BuildingSnapshot']),
                      keep_default=False)


        # Renaming column for 'BuildingSnapshot.block_number' to match new field type.
        db.rename_column(u'seed_buildingsnapshot', 'block_number_id', 'block_number')
        # Changing field 'BuildingSnapshot.block_number'
        db.alter_column(u'seed_buildingsnapshot', 'block_number', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
        # Removing index on 'BuildingSnapshot', fields ['block_number']
        db.delete_index(u'seed_buildingsnapshot', ['block_number_id'])


    def backwards(self, orm):
        # Adding index on 'BuildingSnapshot', fields ['block_number']
        db.create_index(u'seed_buildingsnapshot', ['block_number_id'])

        # Deleting field 'BuildingSnapshot.block_number_source'
        db.delete_column(u'seed_buildingsnapshot', 'block_number_source_id')


        # Renaming column for 'BuildingSnapshot.block_number' to match new field type.
        db.rename_column(u'seed_buildingsnapshot', 'block_number', 'block_number_id')
        # Changing field 'BuildingSnapshot.block_number'
        db.alter_column(u'seed_buildingsnapshot', 'block_number_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['seed.BuildingSnapshot']))
