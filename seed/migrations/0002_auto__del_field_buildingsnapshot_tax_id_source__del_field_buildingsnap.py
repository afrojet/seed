...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BuildingSnapshot.tax_id_source'
        db.delete_column(u'seed_buildingsnapshot', 'tax_id_source_id')

        # Deleting field 'BuildingSnapshot.custom_id_1_id_source'
        db.delete_column(u'seed_buildingsnapshot', 'custom_id_1_id_source_id')

        # Adding field 'BuildingSnapshot.tax_lot_id_source'
        db.add_column(u'seed_buildingsnapshot', 'tax_lot_id_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['seed.BuildingSnapshot']),
                      keep_default=False)

        # Adding field 'BuildingSnapshot.custom_id_1_source'
        db.add_column(u'seed_buildingsnapshot', 'custom_id_1_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['seed.BuildingSnapshot']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BuildingSnapshot.tax_id_source'
        db.add_column(u'seed_buildingsnapshot', 'tax_id_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['seed.BuildingSnapshot'], blank=True),
                      keep_default=False)

        # Adding field 'BuildingSnapshot.custom_id_1_id_source'
        db.add_column(u'seed_buildingsnapshot', 'custom_id_1_id_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['seed.BuildingSnapshot'], blank=True),
                      keep_default=False)

        # Deleting field 'BuildingSnapshot.tax_lot_id_source'
        db.delete_column(u'seed_buildingsnapshot', 'tax_lot_id_source_id')

        # Deleting field 'BuildingSnapshot.custom_id_1_source'
        db.delete_column(u'seed_buildingsnapshot', 'custom_id_1_source_id')
