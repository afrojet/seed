...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BuildingSnapshot.canonical_building'
        db.alter_column(u'seed_buildingsnapshot', 'canonical_building_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seed.CanonicalBuilding'], null=True, on_delete=models.SET_NULL))

        # Changing field 'CanonicalBuilding.canonical_snapshot'
        db.alter_column(u'seed_canonicalbuilding', 'canonical_snapshot_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seed.BuildingSnapshot'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'BuildingSnapshot.canonical_building'
        db.alter_column(u'seed_buildingsnapshot', 'canonical_building_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seed.CanonicalBuilding'], null=True))

        # Changing field 'CanonicalBuilding.canonical_snapshot'
        db.alter_column(u'seed_canonicalbuilding', 'canonical_snapshot_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seed.BuildingSnapshot'], null=True))
