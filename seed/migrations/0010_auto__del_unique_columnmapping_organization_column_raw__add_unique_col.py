...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ColumnMapping', fields ['organization', 'column_raw', 'source_type']
        db.create_unique(u'seed_columnmapping', ['organization_id', 'column_raw', 'source_type'])


    def backwards(self, orm):
        # Removing unique constraint on 'ColumnMapping', fields ['organization', 'column_raw', 'source_type']
        db.delete_unique(u'seed_columnmapping', ['organization_id', 'column_raw', 'source_type'])
