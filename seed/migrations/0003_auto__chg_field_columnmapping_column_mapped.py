...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ColumnMapping.column_mapped'
        db.alter_column(u'seed_columnmapping', 'column_mapped', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ColumnMapping.column_mapped'
        raise RuntimeError("Cannot reverse this migration. 'ColumnMapping.column_mapped' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ColumnMapping.column_mapped'
        db.alter_column(u'seed_columnmapping', 'column_mapped', self.gf('django.db.models.fields.CharField')(max_length=128))
