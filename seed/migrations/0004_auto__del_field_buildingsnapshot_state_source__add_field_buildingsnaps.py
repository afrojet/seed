...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BuildingSnapshot.state_source'
        db.delete_column(u'seed_buildingsnapshot', 'state_source_id')

        # Adding field 'BuildingSnapshot.state_province_source'
        db.add_column(u'seed_buildingsnapshot', 'state_province_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['seed.BuildingSnapshot']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BuildingSnapshot.state_source'
        db.add_column(u'seed_buildingsnapshot', 'state_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['seed.BuildingSnapshot'], blank=True),
                      keep_default=False)

        # Deleting field 'BuildingSnapshot.state_province_source'
        db.delete_column(u'seed_buildingsnapshot', 'state_province_source_id')
